# tsitl.py http://tbgforums.com/forums/viewtopic.php?id=170
# This script will output a copy-and-paste leaderboard for the topic
# "The sky is the limit."
# The score is based on how many times a user has posted on the topic, and so
